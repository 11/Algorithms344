...
\section*{BFS}
	...
	The \textbf{General Algorithm} to \textit{Breadth First Search} is to first look at a vertex and enqueue said vertex. From there, we mark that we visited said vertex and enqueue the neighboring unseen verticies. Repeat this process until the queue is empty.  
